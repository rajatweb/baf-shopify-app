        ...
        <s-stack direction="block" gap="base">
              ...
              <s-stack direction="block" gap="base">
                <div>
                  ...
                  <s-button
                    ...
                    disabled={isUpdating}
                  >
                    {localSettings.collectionSettings?.title ||
                      "Select Collection"}
                  </s-button>
                ...
                <KnobComponent
                  ...
                  selected={
                    localSettings.canvasSettings?.showProductLabels || false
                  }
                  onValueChange={({ name, value }) =>
                    handleChange("canvasSettings", name, value)
                  }
            ...
            <s-stack direction="block" gap="base">
              ...
              <s-stack direction="block" gap="base">
                ...
                <KnobComponent
                  ...
                  selected={
                    localSettings.additionalSettings?.enableAddToCart || false
                  }
                  onValueChange={({ name, value }) =>
          ...
          >
            <s-stack direction="block" gap="base">
              ...
              <KnobComponent
                label="Show branding on exports"
                name="showWatermark"
                selected={
                  localSettings.brandingSettings?.showWatermark || false
                }
                onValueChange={({ name, value }) =>
                  handleChange("brandingSettings", name, value)
                }
              ...
              <div>
                ...
                >
                  <span>
                    ...
                    <span style={{ fontWeight: "normal", color: "#6d7175" }}>
                      (optional)
                    </span>
                  </span>
                  <span
                ...
                <>
                  ...
                  <RangeSliderComponent
                    ...
                    max={100}
                    step={10}
                    value={localSettings.brandingSettings?.logoSize || 75}
                    onValueChange={({ name, value }) =>
                      handleChange("brandingSettings", name, value)
                    }
                    isTextField={true}
