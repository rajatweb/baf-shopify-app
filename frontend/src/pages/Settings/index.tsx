...
const Settings = () => {
  ...
  const { data: { data: storeSettings } = {}, isFetching } =
    useGetSettingsQuery();
                      ...
                      return (
                        ...
                        >
                          <s-stack direction="block">
                            ...
                            {tab.description && (
                              <s-text color="subdued">{tab.description}</s-text>
                            )}
                          </s-stack>
                        </s-clickable>
                      );
              ...
              <div style={{ flex: "1 1 400px", minWidth: "320px" }}>
                ...
                {activeTab === "additional" && (
                  <AdditionalSettings
                    ...
                    updateSettings={updateAdditionalSettings}
                  />
                )}
                {activeTab === "custom-css" && (
                  <CustomCssSettings
                    customCssSettings={settings.customCssSettings}
                    updateSettings={updateCustomCssSettings}
                  />
                )}
              </div>
            </>
